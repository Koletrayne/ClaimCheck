...
- Keep "verdict_explanation" to ONE sentence and always set "confidence".
...
async function analyzeClaim({ text, sourceUrl, academicMode = false, includeSecondaryClaims = false, snapshot = false, includeContextLens = true }) {
